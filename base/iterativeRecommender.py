...
class IterativeRecommender(Recommender):
    def __init__(self,conf,trainingSet,testSet,fold,whetherArtistOrTag):
        super(IterativeRecommender, self).__init__(conf,trainingSet,testSet,fold,whetherArtistOrTag)

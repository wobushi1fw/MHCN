...
class SocialRecommender(IterativeRecommender):
    def __init__(self,conf,trainingSet,testSet,relation,fold,whetherArtistOrTag):
        super(SocialRecommender, self).__init__(conf,trainingSet,testSet,fold,whetherArtistOrTag)
